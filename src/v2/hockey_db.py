...
class HockeyDatabase:
    def __init__(self, columns_file) -> None:
        self.database_columns_csv = pd.read_csv(
        columns_file,
        index_col=False)
        ...
        self.hockey_faceoff_data_table = self.database_columns_csv.to_sql('hockey_faceoff_data_table', self.engine, index=False)
